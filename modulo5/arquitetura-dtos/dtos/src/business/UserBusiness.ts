import { ISignupInputDTO, IGetUsersInputDTO, ILoginInputDTO, IGetUsersOutputDTO, IDeleteUserInputDTO,  IEditUserInputDTO } from './../models/User';
...
export class UserBusiness {
    ...
    public editUser = async (input: IEditUserInputDTO) => {
      const {token, id, email, name, password} = input
